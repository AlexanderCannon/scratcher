...
const TermsOfServicePage = () => {
  // const htmlContent = remark().use(html).processSync(tos).toString();
  ...
  return (
    <Layout>
      <div className="grid grid-cols-1 gap-4">
        ...
        <Typography>
          We are Scratcher Limited, doing business as Scratcher ("Company,"
          "we," "us," "our"), a company registered in California, United States
          at 1001 Laurel Ave, Pomona, CA 91768.
        </Typography>
        <Typography>
          We operate the website https://scratcher.vercel.app/ (the "Site"), the
          mobile application Scratcher (the "App"), as well as any other related
          products and services that refer or link to these legal terms (the
          "Legal Terms") (collectively, the "Services").
        </Typography>
        <Typography>
          You can contact us by phone at 1800-555-1929, email at
          contact@scratcher.zone, or by mail to 1001 Laurel Ave, Pomona, CA
          91768, United States.
        </Typography>
        <Typography>
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ("you"), and
          Scratcher Limited, concerning your access to and use of the Services.
        ...
        <Typography>
          ...
          to new functionality, security updates, and bug fixes, in which case
        ...
        <Typography>
          ...
          please address your request to: contact@scratcher.zone. If we ever
        ...
        <Typography>
          ...
          without written permission from us. Trick, defraud, or mislead us and
          ...
          maintenance of the Services. Engage in any automated use of the
          ...
          make purchases on the Services. Make any unauthorized use of the
          ...
          any revenue-generating endeavor or commercial enterprise. Use the
        ...
        <Typography>
          ...
          Legal Terms. You have the written consent, release, and/or permission
          ...
          any manner contemplated by the Services and these Legal Terms. Your
        ...
        <Typography>
          ...
          are hosted in the United States, Ireland and United Kingdom. If you
          ...
          Ireland and United Kingdom, then through your continued use of the
          Services, you are transferring your data to the United States, Ireland
          and United Kingdom, and you expressly consent to have your data
          transferred to and processed in the United States, Ireland and United
          Kingdom. Further, we do not knowingly accept, request, or solicit
        ...
        <Typography>
          ...
          rules or applicable law, the arbitration will take place in the United
          States of America, California. Except as otherwise provided herein,
        ...
        <Typography>
          ...
          and federal courts located in Los Angeles, California, and the Parties
        ...
        <Typography>
          ...
          PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR $1,500.00 USD. CERTAIN
        ...
        <Typography>
          Scratcher Limited 1001 Laurel Ave Pomona, CA 91768 United States
          Phone: 1800-555-1929 contact@scratcher.zone
        </Typography>
      </div>
    </Layout>
  );
